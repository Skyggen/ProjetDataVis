...
/*!**********************!*\
  !*** ./src/graph.js ***!
  \**********************/
/*! exports provided: updateGraph */
/***/ (function(module, exports) {

eval("throw new Error(\"Module build failed (from ./node_modules/babel-loader/lib/index.js):\\nError: ENOENT: no such file or directory, open 'C:\\\\Users\\\\adrie\\\\OneDrive\\\\Documents\\\\Formation\\\\Heig\\\\Annee-2\\\\VisualDon\\\\Projet\\\\src\\\\graph.js'\");\n\n//# sourceURL=webpack:///./src/graph.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var random_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! random.js */ \"./src/random.js\");\n/* harmony import */ var graph_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! graph.js */ \"./src/graph.js\");\n\n\n\n//# sourceURL=webpack:///./src/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _data_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../data/config */ \"./data/config.js\");\n// problème pour récupérer la clef dans un autre fichier\n // console.log(\"je suis chargé\")\n// Random movie / Random TV Show\n\nvar randomMovie = document.querySelector(\"#randomMovie\");\nvar randomContainer = document.querySelector(\".randomContainer\"); // If randomMovie element exsists..\n\nif (randomMovie) {\n  randomMovie.addEventListener(\"click\", function () {\n    // console.log(\"click\")\n    // Run random movie function.\n    getRandomMovie();\n  });\n}\n\nfunction getRandomMovie() {\n  // Display the random container.\n  randomContainer.style.display = \"block\"; // Get a random page for the API search.\n\n  var minPage = 1;\n  var maxPage = 20;\n  minPage = Math.ceil(minPage);\n  maxPage = Math.floor(maxPage);\n  var randomPage = Math.floor(Math.random() * (maxPage - minPage + 1)) + minPage; // Get a random page for the response result.\n\n  var minResult = 1;\n  var maxResult = 20;\n  minResult = Math.ceil(minResult);\n  maxResult = Math.floor(maxResult);\n  var randomResult = Math.floor(Math.random() * (maxResult - minResult + 1)) + minResult; // Make an api call for a random movie.\n\n  axios.get(\"https://api.themoviedb.org/3/movie/top_rated?api_key=\" + _data_config__WEBPACK_IMPORTED_MODULE_0__[\"API_KEY\"] + '&language=fr&page=' + randomPage).then(function (response) {\n    //console.log(response);\n    var movie = response.data.results[randomResult];\n    var output = \"<div class=\\\"card\\\">\\n\\t\\t\\t<h2>\".concat(movie.title, \"</h2>\\n\\t\\t\\t<div class=\\\"smallMovie\\\">\\n\\t\\t\\t\\t\\t<div class=\\\"card-img-top\\\">\\n\\t\\t\\t\\t\\t\\t<img src=\\\"http://image.tmdb.org/t/p/w185/\").concat(movie.poster_path, \"\\\" onerror=\\\"this.onerror=null;this.src='../images/imageNotFound.png';\\\">\\n\\t\\t\\t\\t\\t</div>\\n                    <div class=\\\"smallMovie_info\\\">\\n                    \\n\\t\\t\\t\\t\\t<p class=\\\"card-text\\\"><strong>VO:</strong> <span>\").concat(movie.original_language, \" </span><strong>Note:</strong> <span>\").concat(movie.vote_average, \" / 10 </span><strong>Date de sortie:</strong> <span>\").concat(movie.release_date, \"</span> </p>\\n\\t\\t\\t\\t\\t<p class=\\\"card-text\\\"><strong>D\\xE9tailles:</strong> <span>\").concat(movie.overview, \"</span></p>\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t</div>\\n\\t\\t\\t</div>\");\n    randomContainer.innerHTML = output;\n  });\n} // Random movie / Random TV Show\n\n\nvar randomTvShow = document.querySelector(\"#randomTvShow\"); // If randomTvShow element exsist..\n\nif (randomTvShow) {\n  randomTvShow.addEventListener(\"click\", function () {\n    // Run random tv show function.\n    getRandomTvShow();\n  });\n}\n\nfunction getRandomTvShow() {\n  // Display the random container.\n  randomContainer.style.display = \"block\"; // Get a random page for the API search.\n\n  var minPage = 1;\n  var maxPage = 20;\n  minPage = Math.ceil(minPage);\n  maxPage = Math.floor(maxPage);\n  var randomPage = Math.floor(Math.random() * (maxPage - minPage + 1)) + minPage; // Get a random page for the response result.\n\n  var minResult = 1;\n  var maxResult = 20;\n  minResult = Math.ceil(minResult);\n  maxResult = Math.floor(maxResult);\n  var randomResult = Math.floor(Math.random() * (maxResult - minResult + 1)) + minResult;\n  axios.get(\"https://api.themoviedb.org/3/tv/top_rated?api_key=\" + _data_config__WEBPACK_IMPORTED_MODULE_0__[\"API_KEY\"] + '&language=fr&page=' + randomPage).then(function (response) {\n    //console.log(response);\n    var show = response.data.results[randomResult];\n    var output = \"<div class=\\\"card\\\">\\n\\t\\t\\t<h2 class=\\\"card-title\\\">\".concat(show.name, \"</h2>\\n\\t\\t\\t<div class=\\\"smallMovie\\\">\\n\\t\\t\\t\\t\\t<div class=\\\"card-img-top\\\">\\n\\t\\t\\t\\t\\t\\t<img src=\\\"http://image.tmdb.org/t/p/w185/\").concat(show.poster_path, \"\\\" onerror=\\\"this.onerror=null;this.src='../images/imageNotFound.png';\\\">\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t<div class=\\\"smallMovie_info\\\">\\n                    <p><strong>VO:</strong> <span>\").concat(show.original_language, \"</span></p>\\n\\t\\t\\t\\t\\t\\t<p id=\\\"p_rating\\\"><strong>Note:</strong> <span>\").concat(show.vote_average, \" / 10</span> </p>\\n                        <p><strong>Date de sortie:</strong> <span>\").concat(show.first_air_date, \"</span></p>\\n                        <p><strong>D\\xE9tailles:</strong> <span>\").concat(show.overview, \"</span></p>\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t</div>\\n\\t\\t\\t</div>\");\n    randomContainer.innerHTML = output;\n  });\n}\n\n//# sourceURL=webpack:///./src/random.js?");
